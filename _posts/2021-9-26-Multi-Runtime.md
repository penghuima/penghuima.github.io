...
上述功能不特指具体使用案例，它表述的是一个通用原语的良好集合，这些原语正是创建优秀的分布conector式系统所需的。如今，许多平台都提供了这样的功能，但是本文中我们要探讨的是过去十年中我们使用这些功能的方式如何变化，以及在下一个十年中它又将如何变化。为了进行比较，让我们看一下过去的十年，基于 Java 的中间件如何满足这些需求。
